      ...
      <div style={{ width: "100%", height: "350px" }}>
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={filteredData}>
            ...
            <Tooltip />
            <Legend />
            <Area type="monotone" dataKey="desktop" stroke="#8884d8" fill="url(#colorDesktop)" name="Desktop" />
            <Area type="monotone" dataKey="mobile" stroke="#82ca9d" fill="url(#colorMobile)" name="Mobile" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
